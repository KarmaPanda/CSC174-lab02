...
<html lang="en">
    ...
    <body>
        ...
        <article>
            ...
            <p>Fully autonomous vehicles, also known as driverless cars, already exist in prototype (such as the Google driverless car) but have a long way to go before they are in general use.</p>

            <h2>Open source development</h2>
            <p>There have been several projects aiming to develop a car on the principles of open design, an approach to designing in which the plans for the machinery and systems are publicly shared, often without monetary compensation. The projects include OScar, Riversimple (through 40fires.org) and c,mm,n. None of the projects have reached significant success in terms of developing a car as a whole both from hardware and software perspective and no mass production ready open-source based design have been introduced as of late 2009. Some car hacking through on-board diagnostics (OBD) has been done so far.</p>

            <h2>Car sharing</h2>
            <p>Car-share arrangements and carpooling are also increasingly popular, in the US and Europe. For example, in the US, some car-sharing services have experienced double-digit growth in revenue and membership growth between 2006 and 2007. Services like car sharing offering a residents to "share" a vehicle rather than own a car in already congested neighborhoods.</p>
        </article>

        <aside>
            <h2>List of current automobile manufacturers</h2>
            <h3>Automobile manufacturers in the USA</h3>
            <p>The automotive industry in the United States began in the 1890s and, as a result of the size of the domestic market and the use of mass production, rapidly evolved into the largest in the world. However, the United States was overtaken as the largest automobile producer by Japan in the 1980s, and subsequently by China in 2008. The U.S. is currently second among the largest manufacturer in the world by volume, with approximately 8-10 million manufactured annually. Notable exceptions were 5.7 million automobiles manufactured in 2009 (due to crisis), and peak production levels of 13-15 million units during the 1970s and early 2000s.</p>
            <p>The motor vehicle industry began with hundreds of manufacturers, but by the end of the 1920s it was dominated by three large companies: General Motors, Ford, and Chrysler, all based in Metro Detroit. After the Great Depression and World War II, these companies continued to prosper, and the U.S. produced nearly three quarters of all automobiles in the world by 1950 (8,005,859 of 10,577,426). Beginning in the 1970s, a combination of high oil prices and increased competition from foreign auto manufacturers severely affected the companies. In the ensuing years, the companies periodically bounced back, but by 2008 the industry was in turmoil due to the aforementioned crisis. As a result, General Motors and Chrysler filed for bankruptcy reorganization and were bailed out with loans and investments from the federal government. But according to Autodata Corp, June 2014 seasonally adjusted annualized sales is the biggest in history with 16.98 million vehicles and toppled previous record in July 2006.</p>
        ...
        <footer>
            <h2>Citations</h2>
            <ul>
                <li><a href="https://archive.org/details/australianpocket00john">Fowler, H.W.; Fowler, F.G., eds. (1976)</a></li>
                <li><a href="https://www.abebooks.com/AUTOMOBILE-BOOK-Stein-Ralph-Paul-Hamlyn/591304558/bd">Stein, Ralph (1967). The Automobile Book. Paul Hamlyn.</a></li>
                <li><a href="http://www.oed.com/view/Entry/122742#eid35698343">OED Online. Oxford University Press. September 2014. Retrieved 29 September 2014.</a></li>
            </ul>
            <h2>Sources</h2>
            <ul>
                <li><a href="https://en.wikipedia.org/wiki/Car">Wikipedia Car</a></li>
                <li><a href="https://en.wikipedia.org/wiki/List_of_automobile_manufacturers">Wikipedia List of automobile manufacturers</a></li>
                <li><a href="https://en.wikipedia.org/wiki/Automotive_industry_in_the_United_States">Wikipedia Automotive industry in the United States</a></li>
