...
<head> 
	<meta charset="utf-8">
	<title>Holden</title>
    <link rel="stylesheet" type="text/css" href="css/holden.css"> 
...
<header>  
	<h1>Holden</h1>  
	<div>The aussie car company</div>
</header>
...
<footer>
    ...
    <h2>Citations</h2>
        ...
        <li>Davis, Tony; Kennedy, Alistair; Kennedy, Ewan (February 2007), <a href="https://web.archive.org/web/20070926214934/http://media.gmcanada.com:8221/aus/holden/en/company/history/HH13Part1.pdf">The Holden Heritage</a> – 13th Edition, Port Melbourne, Victoria: GM Holden.</li>
        <li>Mendelssohn, Joanna (28 June 2017), <a href="https://theconversation.com/celebrating-the-feminist-holden-80054">Celebrating the Feminist Holden</a>.</li>
        <li>Wagner, David Paul, <a href="https://www.australiaforvisitors.com/canowindra-motors-holden-museum.html">Canowindra Motors Holden Museum</a>.</li>

        </ul>
        
    <h2>Source</h2>
    
        <p>From Wikipedia: <a href="https://en.wikipedia.org/wiki/holden">Holden.</a> This webpage, by Jaafar Al Hadab</p>
